...
from application.dto import ErrorDto, LmmResponseDto
from domain.exceptions import LmmException
from infrastructure.config.canonical_logger_config import put_log_context, clear_log_context
from fastapi import APIRouter, Depends
from infrastructure.utils.parse_utils import convert_webm_to_wav
from infrastructure.config.ioc.service import get_embedding_service, get_vector_service, get_lmm_service
from application.ports.driving import EmbeddingUseCase, VectorUseCase, LmmUseCase
...
async def websocket_endpoint(
    ...
    lmm_service: LmmUseCase = Depends(get_lmm_service)
):
