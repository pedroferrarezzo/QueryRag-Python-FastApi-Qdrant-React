...
from config.env_config import MINIO_BUCKET_NAME
from config.minio_config import client, base_console_url

from ports.object_storage_port import ObjectStorageRepository
