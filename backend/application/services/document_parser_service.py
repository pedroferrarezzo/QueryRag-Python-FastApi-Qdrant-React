import re
from domain.exceptions import InvalidValueException, ParseException
from domain.ports.driven import DocumentParser
from application.ports.driving import DocumentParserUseCase

class DocumentParserService(DocumentParserUseCase):
