...
from domain.ports.driven import ObjectStorageRepository
from application.ports.driving import ObjectStorageUseCase

class ObjectStorageService(ObjectStorageUseCase):
